    ...
    <div className="relative min-h-screen flex items-center justify-center bg-[#0b1220] text-white overflow-hidden p-6">
      ...
      <div className="relative w-full max-w-md animate-in fade-in zoom-in duration-700">
        ...
        <div className="flex flex-col items-center mb-10">
          <div className="w-16 h-16 bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl flex items-center justify-center mb-6 shadow-2xl group transition-all duration-500 hover:border-emerald-500/50">
